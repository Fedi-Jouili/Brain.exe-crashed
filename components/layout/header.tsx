...
import { Menu, User, Settings, BarChart3, LogOut, LogIn } from "lucide-react"
...
export function Header() {
  ...
  const disposableIncome = financialAnalysis?.disposable_income ?? 
    (profile ? profile.monthly_income - profile.monthly_expenses : 0)
              ...
              <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 hover:bg-primary/20 transition-colors">
                      <User className="h-5 w-5 text-primary" />
