...
import { useProfileStore, useSearchStore, useRecentSearchStore, useAuthStore } from "@/lib/store"
import { searchApi, APIError, NetworkError, AuthError } from "@/lib/api"
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const filters = {
        ...
        financing_available: financingAvailable || undefined,
      }
      ...
      if (err instanceof NetworkError) {
        ...
        setError("Please sign in to search with your profile.")
            ...
            <CardContent className="flex items-start gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  {isAuthenticated
                    ? "Complete your profile to see affordability analysis and personalized recommendations."
                    : "Sign in and complete your profile to see affordability analysis and personalized recommendations."}
                </p>
                <Button
                  variant="link"
                ...
                >
                  {isAuthenticated ? "Set up profile" : "Sign in"}
                </Button>
              </div>
            </CardContent>
          </Card>
